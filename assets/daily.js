...
/* date */
let firstDayofMonth1= new Date(currYear, currMonth, 1).getDate(), // getting first day of month
lastDateofMonth1= new Date(currYear, currMonth + 1, 0).getDate(); // getting last date of month
let bv=1
const nu=[]
while(bv!=lastDateofMonth1)
{
   nu.push(bv);
   bv++;
}
...
document.getElementById('dat5').innerHTML=noob+"/"+bot;
